...
// Convert documents
var DocConvertingHandler = function(options) {
  var that = {};
  that.dirStack = [];
  that.paths = [];  // public
...
exports.jesyllApp = jesyllApp = function(options) {
  ...
  var handler = DocConvertingHandler(sourceTree, options);
  walk(sourceTree, handler);
  return convertDocs(options);
};
