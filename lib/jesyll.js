...
var Templates = function(templatesDir) {
  ...
  that.makeHtml = function(doc, body) {
    ...
    var templateName = doc.get('template') || 'default',
...
var handleSource = function(sourceTree, sourceFile) {
  ...
  var extracted = extractMetadata(sourceFile),
      ...
      parsedAndExpanded = util.expandSpecial(parsed, sourceTree);
      doc = util.ObjComposite(defaults, extracted, parsedAndExpanded);
