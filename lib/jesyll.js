...
parser.option("-s", "--source-dir", "source-dir")
    .help("NYI: Use this source directory")
    .set();

parser.option("-d", "--dest-dir", "dest-dir")
    .help("Use this destination directory")
    .set();
...
exports.jesyllApp = jesyllApp = function(options) {
  return {
    'run': function() {
      var source = options.get('source-dir'), dest = options.get('dest-dir');
...
var parseConfig = function(source) {
  ...
  var config;
  // TODO: Better to try to open the file and then fail
